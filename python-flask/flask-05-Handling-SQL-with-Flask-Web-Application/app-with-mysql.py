...
app.config['MYSQL_DATABASE_HOST'] = 'mysql.ctgvpcuwckbu.us-east-1.rds.amazonaws.com'
...
VALUES 
	("Nergis", "nergis@amazon.com" ),
	("Ayse", "ayse@microsoft.com"),
	("Frederic", "frederick@facebook.com"),
    ("Orkhan", "orkhan@tesla.com"),
    ("Sidika","sidika@google.com");
"""
